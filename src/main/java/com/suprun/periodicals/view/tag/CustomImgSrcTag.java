...
public class CustomImgSrcTag extends SimpleTagSupport {
    ...
    private static final String LOGO_FILE_PATH = Resource.FILE_UPLOAD.getProperty("logo.file.path");
    ...
    public void doTag() throws IOException {
        ...
        try {
            ...
            URL fileLocation = this.getClass().getClassLoader().getResource(LOGO_FILE_PATH);
            Path file = null;
